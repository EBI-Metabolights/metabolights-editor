...
@Directive({ // linter says this should be used as an attribute on a tag but its a mock
  selector: 'app-validation-detail', // eslint-disable-line @angular-eslint/directive-selector
})
export class MockValidationDetailComponent { // eslint-disable-line @angular-eslint/directive-class-suffix
