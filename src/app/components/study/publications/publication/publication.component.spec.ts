...
describe('PublicationComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      imports: [HttpClientTestingModule, FormsModule, ReactiveFormsModule, CommonModule, BrowserModule, ],
      providers: [{provide: DOIService, useClass: MockDOIService}, {provide: EditorService, useClass: MockEditorService}, {provide: EuropePMCService, useClass: MockEuropePMCService}, NgRedux]
    })
    .compileComponents();
  }));
